@php
    ...
    // Wishlist is an optional module: render nothing if it is not installed.
    if (!class_exists(\App\Nexus\Modules\Wishlist\Enums\WishlistableTypeEnum::class) || !method_exists($model, 'wishlistItems')) {
        return;
    }
