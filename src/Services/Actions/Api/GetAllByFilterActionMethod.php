...
class GetAllByFilterActionMethod
{
    ...
    )
    {
        ...
        $resource = $moduleConfig->methodResource['getAllByFilter']['resources'][$recourseType] ?? null;
        $with = $moduleConfig->methodResource['getAllByFilter']['with'] ?? null;
