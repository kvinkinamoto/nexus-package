...
class GetAllByFilterPaginateActionMethod
{
    public static function handle(
        ...
        $resource = $moduleConfig->methodResource['getAllByFilterPaginate']['resources'][$recourseType] ?? null;
        $with = $moduleConfig->methodResource['getAllByFilterPaginate']['with'] ?? null;
