...
(function (global, factory) {
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.switchTab = function switchTab(item, reload) {
      ...
      $__default["default"](SELECTOR_TAB_NAVBAR_NAV + " .active").tab('dispose').removeClass('is_active');

      this._fixHeight();

      $item.tab('show');
      $item.parents('li').addClass('is_active');
    ...
    _proto._setItemActive = function _setItemActive(href) {
      $__default["default"](SELECTOR_SIDEBAR_MENU_ITEM + ", " + SELECTOR_HEADER_DROPDOWN_ITEM).removeClass('is_active');
      $__default["default"](SELECTOR_HEADER_MENU_ITEM).parent().removeClass('is_active');
      var $headerMenuItem = $__default["default"](SELECTOR_HEADER_MENU_ITEM + "[href$=\"" + href + "\"]");
      var $headerDropdownItem = $__default["default"](SELECTOR_HEADER_DROPDOWN_ITEM + "[href$=\"" + href + "\"]");
      var $sidebarMenuItem = $__default["default"](SELECTOR_SIDEBAR_MENU_ITEM + "[href$=\"" + href + "\"]");
      $headerMenuItem.each(function (i, e) {
        $__default["default"](e).parent().addClass('is_active');
      });
      $headerDropdownItem.each(function (i, e) {
        $__default["default"](e).addClass('is_active');
      });
      $sidebarMenuItem.each(function (i, e) {
        $__default["default"](e).addClass('is_active');
        $__default["default"](e).parents('.nav-treeview').prevAll('.nav-link').addClass('is_active');
      });
    };
