  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function initialize() {
      ...
      this.$content.on('click', '.note-hint-item', function (e) {
        _this2.$content.find('.active').removeClass('is_active');

        external_jQuery_default()(e.currentTarget).addClass('is_active');
    ...
    value: function selectItem($item) {
      this.$content.find('.active').removeClass('is_active');
      ...
      if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
        ...
        if (this.hints.length && keyword) {
          ...
          if (bnd) {
            ...
            this.$content.find('.note-hint-item:first').addClass('is_active'); // set position for popover after group is created
...
var DropdownUI = /*#__PURE__*/function () {
  ...
  DropdownUI_createClass(DropdownUI, [{
    ...
    value: function clear() {
      ...
      $parent.find('.note-btn.active').removeClass('is_active');
      $parent.removeClass('open');
    }
  }, {
    key: "show",
    value: function show() {
      this.$button.addClass('is_active');
    ...
    key: "hide",
    value: function hide() {
      this.$button.removeClass('is_active');
...
external_jQuery_default()(document).on('click', function (e) {
  if (!external_jQuery_default()(e.target).closest('.note-btn-group').length) {
    ...
    external_jQuery_default()('.note-btn-group .note-btn.active').removeClass('is_active');
  }
});
external_jQuery_default()(document).on('click.note-dropdown-menu', function (e) {
  ...
  external_jQuery_default()(e.target).closest('.note-dropdown-menu').parent().find('.note-btn.active').removeClass('is_active');
});
...
var ui = function ui(editorOptions) {
  return {
    ...
    toggleBtnActive: function toggleBtnActive($btn, isActive) {
      $btn.toggleClass('is_active', isActive);
    },
