        ...
        <div class="flex items-center gap-1.5">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-cloak x-transition
                    ...
                    <a href="{{ route('nexus.module.action', ['module' => 'settings', 'action' => 'edit', 'id' => \App\Nexus\Modules\Settings\Models\Settings::current()->id]) }}" class="flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/5">
