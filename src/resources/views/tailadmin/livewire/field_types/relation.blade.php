...
@endphp
<div class="mb-4" wire:key="relation-{{ $field->name }}">
        ...
        @unless($isDisabled)
            <div class="relative">
                ...
                @if(!empty($this->relationSearchResults[$field->name]))
                    <div class="absolute z-40 mt-1 max-h-60 w-full overflow-y-auto rounded-lg border border-gray-200 bg-white py-1 shadow-theme-lg dark:border-gray-800 dark:bg-gray-900">
