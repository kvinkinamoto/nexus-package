...
@else
    ...
    @if(config('app.debug'))
        <div class="my-2 rounded-lg border border-warning-200 bg-warning-50 px-3 py-2 text-xs text-warning-700 dark:border-warning-800 dark:bg-warning-500/10 dark:text-warning-400">
